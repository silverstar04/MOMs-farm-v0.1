...
- 빌드 도구 없음
- npm 사용 없음
- `index.html`, `style.css`, `script.js`, `firebase-ranking.js` 중심 구조
- 이미지 자산은 `assets/...` 상대경로 사용
- Firebase 랭킹은 CDN module import 방식 사용
- 현재 구현: 밭, 작물, 가방 판매, 밭 업그레이드, 날씨/동네뉴스/시세, 가공 건물, 동물 생산, Firebase 랭킹
...
|---|---|---:|---:|---:|
| 밀가루 | 풍차: 밀 2개 -> 밀가루 1개, 20초 | 9G | 8~11G | 18개 |
| 소 사료 | 사료공장: 밀 2개 -> 소 사료 1개, 24초 | 7G | 6~8G | 22개 |
| 닭 사료 | 사료공장: 옥수수 2개 -> 닭 사료 1개, 24초 | 6G | 5~7G | 24개 |
| 계란 | 닭 + 닭 사료 1개, 28초 | 12G | 10~14G | 16개 |
| 우유 | 소 + 소 사료 1개, 40초 | 18G | 16~21G | 12개 |
...
- 배경 이미지: 폭 720px 기준
- 빵과 베이커리 이미지는 아직 코드에 연결하지 않고 자산만 분류해 둔 상태
